--fct_hn_order_items_shopify_07082026 

create or replace table bi.mark_dev.fct_order_items as

WITH temp_orders AS (SELECT * FROM bi.historical_newspapers_shopify.int_temp_orders)
, unit_and_profit AS (SELECT * FROM bi.mark_dev.int_finance_unit_profit_and_loss)
