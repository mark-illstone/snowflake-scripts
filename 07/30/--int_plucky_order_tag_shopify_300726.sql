--int_plucky_order_tag_shopify_300726

CREATE OR REPLACE TABLE bi.mark_dev.int_plucky_order_tag_shopify AS

WITH order_tag AS (SELECT * FROM bi.fivetran_shopify_plucky.order_tag)
