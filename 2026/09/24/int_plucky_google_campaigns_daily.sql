...
with campaigns as (select * from bi.fivetran_google_ads.campaigns_daily)
   ,   accounts as (select * from bi.fivetran_google_ads.account_history)
...
, campaigns_temp as (
    select
        ...
        ,
            ...
            END AS country
    from campaigns
    where customer_id = '3544478401' --Plucky Books account only
)
