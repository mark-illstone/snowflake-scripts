CREATE OR REPLACE TABLE bi.mark_dev.int_base_performance_max_spend AS

WITH performance_max_daily_update AS (SELECT * FROM bi.fivetran_google_ads.campaigns_daily)
...
FROM performance_max_daily_update
