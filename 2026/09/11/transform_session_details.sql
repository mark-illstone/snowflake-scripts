create or replace table bi.mark_dev.transform_session_details as

/*
This table contains all of the session data, including geo and device data
*/
...
select 
    ...
    GREATEST(COALESCE(orig_events.funnel_add_to_cart, 0), COALESCE(sessions.funnel_add_to_cart, 0)) AS funnel_add_to_cart
    
FROM bi.mark_dev.preprocess_sessions sessions
...
LEFT JOIN bi.mark_dev.preprocess_sessions orig_events
