...
WITH facebook_structured_ads AS (SELECT * FROM bi.dbt_production_intermediate.int_facebook_structured_ads)
   ...
   , ai_assistant_structured_ads AS (SELECT * FROM bi.dbt_production_intermediate.int_ai_assistant_structured_ads)
   , sms_structured_ads AS (SELECT * FROM bi.mark_dev.int_sms_structured_ads)
