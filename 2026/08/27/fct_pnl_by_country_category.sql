...
, order_brand AS (
    SELECT DISTINCT
        ...
        CASE WHEN NOT is_repeat THEN 1 END AS new_count,
...
orders_agg AS (
    ...
    GROUP BY day, sub_category, brand, sub_product_type, trade_country_group
),
...
items_agg AS (
    SELECT
        ...
        CASE
            ...
            ELSE 'ROW'
        END AS trade_country_group,
        SUM(CASE WHEN NOT is_repeat THEN 1 END) AS new_count,
...
JOIN orders_agg o
    ...
    AND i.sub_product_type = o.sub_product_type